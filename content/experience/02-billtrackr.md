...
points:
  ...
  - Cut bill update and generation from **~55 minutes to under 7** with project-linked invoices, receipt tracking, deductions, and exports.
  - Architected a multi-tenant backend with tenant isolation, role-based access control, and tiered subscriptions with real-time feature gating.
...
Civil engineering consultancies are often paid in instalments across three to
five years, so the domain object is not only an invoice. It is an outstanding
